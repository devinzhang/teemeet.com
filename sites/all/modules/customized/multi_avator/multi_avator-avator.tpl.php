...
<li><a class="colorbox-load canDo D_signal D_signal_appear_to_confirmProfilePhotoDelete deleteProfilePhoto" href="<?php print url('multi_avator/delete/'.$uid.'/'.$fid);?>"><?php print t('Delete');?></a></li>
