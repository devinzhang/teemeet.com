...
<body id="<?php print $body_id; ?>" class="<?php print $body_classes; ?> front">
 ...
 <div id="C_header">
  <div id="C_headerBody">
    <div id="C_logo"> <a href="<? echo url('<front>')?>"> <img src="<? global $base_url;  echo $base_url.$logo ?>" alt="<? echo $site_name ?>" /> </a> </div>
    <div id="C_userNav">
    <? if($user->uid): ?>
      <div id="C_welcome">
    ...
    <? endif; ?>  
      <ul id="C_userLinks">
        <li class="C_userNavItem C_userNavItem_less"><a href="<?php print url('whats_new')?>">新鲜事<span class="help_new"><?php print $whats_new_count?> <span></a></li>
